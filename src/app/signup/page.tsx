        ...
        <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/10 hover:border-white/20 transition-all duration-500">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label htmlFor="name" className="text-sm font-medium text-gray-300 tracking-wide">
                Full Name
              </label>
            ...
            <div className="space-y-2">
              <label htmlFor="confirmPassword" className="text-sm font-medium text-gray-300 tracking-wide">
                Confirm Password
              </label>
              <div className="relative">
                <input
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-black/40 text-gray-400 font-medium tracking-wide">or sign up with</span>
              </div>
            </div>
